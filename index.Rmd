...
[OxShef: Charts](http://charts.oxshef.io) provides advice on how to select the most appropriate charts for your data and how to avoid common mistakes when visualising data. Subjects covered include:
...
- [Shiny: Interactive visualisations built with R](https://shiny.oxshef.io)
...
Additionally, we encourage collaborations between academics and data journalists at a wide range of international media outlets. Read more on our [dedicated OxShef: Publishers website](http://publishers.oxshef.io).
