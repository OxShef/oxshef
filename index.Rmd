...
[OxShef: Charts](oxshef.github.io/oxshef_charts) provides an overview of commonly used data visualisations by researchers at Oxford and Sheffield, these include:
...
[OxShef: Charts](oxshef.github.io/oxshef_charts) provides advice on how to select the most appropriate charts for your data and how to avoid common mistakes when visualising data. There are dedicated websites to how to build visualisations with specific tools:
